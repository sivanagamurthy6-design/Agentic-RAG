...
class GraphState(TypedDict, total=False):
    ...
    file_paths: list[str]           # list of file paths uploaded by the user (for debugging)
    ...
    #using for Tavily check node to check if the user query is related to tavily or not
    ...
    #vector_store: Any
    #bm25_retriever: Any
    # build_embeddings will add these to the state, so we need to declare them here. They can be of any type since they are complex objects from LangChain.
